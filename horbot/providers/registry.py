...
class ProviderSpec:
    ...
    display_name: str = ""          # shown in `horbot status`
...
PROVIDERS: tuple[ProviderSpec, ...] = (
    ...
    # MiniMax: uses OpenAI-compatible API mode.
    ...
    ProviderSpec(
        ...
        litellm_prefix="openai",            # MiniMax-M2.5 → openai/MiniMax-M2.5 (OpenAI-compatible mode)
        skip_prefixes=("openai/", "minimax/", "openrouter/"),
        env_extras=(),
        is_gateway=False,
        is_local=False,
        detect_by_key_prefix="",
        detect_by_base_keyword="",
        default_api_base="https://api.minimax.com/v1",
        strip_model_prefix=False,
        model_overrides=(),
    ),
...
def create_provider(
    ...
    Args:
        ...
        extra_headers: Extra headers to send with API requests
