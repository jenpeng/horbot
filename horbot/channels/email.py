...
from horbot.config.schema import EmailConfig
...
class EmailChannel(BaseChannel):
    ...
    def __init__(self, config: EmailConfig, bus: MessageBus, **channel_kwargs):
    ...
    async def send(self, msg: OutboundMessage) -> None:
        ...
        base_subject = self._last_subject_by_chat.get(to_addr, "horbot reply")
    ...
    def _reply_subject(self, base_subject: str) -> str:
        subject = (base_subject or "").strip() or "horbot reply"
