...
from horbot.config.schema import MochatConfig
from horbot.utils.helpers import get_data_path
...
class MochatChannel(BaseChannel):
    ...
    def __init__(self, config: MochatConfig, bus: MessageBus, **channel_kwargs):
