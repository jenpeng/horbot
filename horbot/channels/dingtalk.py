...
from horbot.config.schema import DingTalkConfig
...
class WorkhorseDingTalkHandler(CallbackHandler):
    """
    Standard DingTalk Stream SDK Callback Handler.
    Parses incoming messages and forwards them to the Workhorse channel.
    """
    ...
    async def process(self, message: CallbackMessage):
        ...
        try:
            ...
            # Forward to Workhorse via _on_message (non-blocking).
...
class DingTalkChannel(BaseChannel):
    ...
    def __init__(self, config: DingTalkConfig, bus: MessageBus, **channel_kwargs):
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            handler = WorkhorseDingTalkHandler(self)
    ...
    async def _on_message(self, content: str, sender_id: str, sender_name: str) -> None:
        """Handle incoming message (called by WorkhorseDingTalkHandler).
