...
class ToolRegistry:
    ...
    def get_definitions_smart(self, user_message: Any = None, max_tools: int = 50, include_web_search: bool = False) -> list[dict[str, Any]]:
        ...
        KEYWORD_TOOL_MAP = {
            ...
            "pptx": {"mcp_office-powerpoint", "mcp_officecli"},
            ...
            "excel": {"mcp_excel", "mcp_office-excel", "mcp_officecli"},
            "xlsx": {"mcp_excel", "mcp_office-excel", "mcp_officecli"},
            "表格": {"mcp_excel", "mcp_office-excel", "mcp_officecli"},
            "spreadsheet": {"mcp_excel", "mcp_office-excel", "mcp_officecli"},
            "office": {"mcp_officecli", "mcp_office-word", "mcp_office-excel", "mcp_office-powerpoint"},
            "officecli": {"mcp_officecli"},
            "openxml": {"mcp_officecli", "mcp_office-word", "mcp_office-excel", "mcp_office-powerpoint"},
